...
var post_response_dto_1 = require("./dto/post-response.dto");
var PostsService = /** @class */ (function () {
    function PostsService(repository) {
        this.repository = repository;
        this.logger = new common_1.Logger(PostsService_1.name);
    }
    PostsService_1 = PostsService;
    PostsService.prototype.findAll = function (authorName) {
        return __awaiter(this, void 0, void 0, function () {
            var posts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!authorName) return [3 /*break*/, 2];
                    ...
                    case 3:
                        posts = _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/, posts.map(post_response_dto_1.default.from)];
                }
            });
        });
    };
